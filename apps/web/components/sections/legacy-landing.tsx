...
// ─────────────────────────────────────────────────────────────────────────────
// LEGACY landing-page sections — extracted from app/page.tsx.
//
// These are the ORIGINAL (pre-yash-components) landing sections. They are kept
// here for reference and are no longer rendered on the live landing page, which
// now uses the components under components/yash-components/*.
//
// Nothing here is imported by the live page. To bring a block back, import the
// relevant piece (or <LegacyLandingSections />) into app/page.tsx.
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// The legacy sections, as one component. Self-contained: owns the Q&A demo
// state it needs. Render <LegacyLandingSections /> to bring them all back.
// ─────────────────────────────────────────────────────────────────────────────

export function LegacyLandingSections() {
  ...
  useEffect(() => {
    if (simStage === "idle") handleSelectPreset(0);
  }, [simStage]);
