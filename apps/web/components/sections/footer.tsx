...
const NAV = {
  ...
  Company: [
    ...
    { label: "Blog", href: "#" },
    { label: "Careers", href: "#" },
    { label: "Contact", href: "mailto:hello@neuron.ai" },
  ],
  Legal: [
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-[12px] text-muted-foreground leading-relaxed max-w-[180px]">
              The shared memory layer for digital agencies.
            </p>
          ...
          {Object.entries(NAV).map(([group, links]) => (
            <div key={group}>
              <p className="text-[11px] font-semibold uppercase tracking-widest text-foreground mb-4">
                {group}
              </p>
