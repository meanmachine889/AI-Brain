...
const PORTFOLIO = "https://yxsh.in";
const GITHUB = "https://github.com/meanmachine889";
    ...
    >
      <div className="flex flex-col items-start gap-4">
        ...
        <p className="text-base font-light leading-relaxed text-muted-foreground sm:text-lg">
          The shared memory layer for agencies.
        </p>
        ...
        <p className="mt-3 text-base font-light text-muted-foreground">
          ...
          className="mt-1 text-base text-black underline underline-offset-1 font-light transition-colors hover:text-foreground"
        >
          yxsh.in
        </a></span>
        </p>
